...
const  SearchContainer = ()=>{
    ...
    const GetDataTrending = async ()=>{
        ...
        const {data} = await axios.get(`https://api.themoviedb.org/3/search/${typeValue}?api_key=21fddb77f2e324d8cec1f07a7790a1af&page=${pageno}&language=en-US&query=${searchValue}&include_adult=false`);
