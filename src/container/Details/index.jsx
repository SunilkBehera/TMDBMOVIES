...
const DetailsContainer =()=>{
  ...
  const fetchData = async ()=>{
    try {
        const {data}  = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}?api_key=21fddb77f2e324d8cec1f07a7790a1af&language=en-US`);
        setContent(data);
  ...
  const fetchVideo = async()=>{
    try {
      const {data}  = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}/videos?api_key=21fddb77f2e324d8cec1f07a7790a1af&language=en-US`);
...
const creditsFetch = async ()=>{
  try{
    const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}/credits?api_key=21fddb77f2e324d8cec1f07a7790a1af&language=en-US`);
